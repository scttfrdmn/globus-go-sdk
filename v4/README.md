...
- ✅ **Transfer**: File transfer operations, endpoint management, directory operations
- ✅ **Search**: Search index operations, querying, ingestion
- ✅ **Flows**: Flow management and execution
- ✅ **Timers**: Timer scheduling with flow integration
- ✅ **Compute**: Compute endpoint management, function execution
...
|--------|------------|--------|
| v4.1.0-1 | v4.1.0 | ⚠️ Initial (Auth + Groups only) |
| v4.1.0-2 | v4.1.0 | ✅ Complete (All Services) |
